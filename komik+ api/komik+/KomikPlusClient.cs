...
using KomikPlus.Models.Recommends;
using KomikPlus.Models.Searches;

namespace KomikPlus;

/// <summary>
///     Client for interacting with the Komik+ manga API
/// </summary>
public class KomikPlusClient : IDisposable
{
    /// <summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the KomikPlusClient
    /// </summary>
    ...
    public KomikPlusClient(string userAgent, Dictionary<string, string>? cookies = null)
    {
        _rand = new Random();
